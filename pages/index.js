...
export default function HomePage() {
  ...
  const fetchAccountDetails = async (token) => {
    try {
      const response = await fetch("http://backend:3001/me/accounts", {
        method: "POST",
        headers: {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch("http://backend:3001/sessions", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleDeposit = async (e) => {
    ...
    try {
      const response = await fetch(
        "http://backend:3001/me/accounts/transactions",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
